...
// 敵のアイコンとタイトル、制限時間（難易度アップ）
const ENEMY_DATA = {
  1: { icon: '👹', name: '初級の鬼', timeLimit: 45, requiredWords: 8 },
  2: { icon: '🐉', name: '中級の竜', timeLimit: 35, requiredWords: 10 },
  3: { icon: '💀', name: '最終ボス', timeLimit: 25, requiredWords: 12 }
}
  ...
  return (
    <div className="container mx-auto px-4 py-4 max-w-4xl">
      ...
      <div className="text-center mb-4">
        <h2 className="text-xl font-semibold">ラウンド {gameState.round}/3</h2>
          ...
          <div className="w-32 bg-gray-200 rounded-full h-4 mt-2">
            <div 
              className={`h-4 rounded-full transition-all duration-300 ${
                gameState.playerHP > 50 ? 'bg-green-500' : 
      ...
      <div className="max-w-xl mx-auto flex-1 flex flex-col justify-center">
        ...
        {gameState.gameStatus === 'playing' && (
          <div className="text-center">
            ...
            <div className="mb-4">
              <div className={`text-2xl font-bold mb-3 p-3 rounded-lg ${
                gameState.specialType === 'bonus' ? 'bg-green-100 border-2 border-green-400' :
            ...
            <input
              ...
              className={`w-full max-w-sm px-3 py-2 text-lg border-2 rounded-lg focus:outline-none transition-colors ${
                effectState.showDamage 
